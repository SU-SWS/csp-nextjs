    ...
    <li {...props} ref={menuItemRef}>
      ...
      {children && (
        <>
          <button
            aria-labelledby={id}
            className="group relative right-10 col-start-10 w-fit shrink-0 rounded-full border-b border-transparent bg-white text-black active:text-black hocus:bg-white hocus:text-black hocus-visible:border-black lg:right-0 lg:mt-2 lg:rounded-full lg:border-transparent lg:bg-transparent lg:text-archway-light lg:aria-current-page:text-cardinal-red lg:hocus:bg-transparent lg:hocus:text-archway-light lg:hocus-visible:border lg:hocus-visible:border-archway-light"
            ref={buttonRef}
