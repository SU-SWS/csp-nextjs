...
const fixClasses = (classes?: string | boolean): string => {
  ...
  classes = classes
    ...
    .replaceAll(
      " drop-cap ",
      " type-2 font-normal font-sans first-letter:font-serif first-letter:font-bold first-letter:type-6 first-letter:float-left first-letter:-mt-8 first-letter:mr-4 first-letter:leading-none "
    )
